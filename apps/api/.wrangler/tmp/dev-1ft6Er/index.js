...
// .wrangler/tmp/bundle-MPyx6R/strip-cf-connecting-ip-header.js
...
var GeminiService = class {
  ...
  async refinePrompt(originalText) {
...
// src/imagen.ts
var ImagenService = class {
  apiKey;
  modelName;
  accountId;
  // If using CF logic or specific endpoint, but here assuming Google AI Studio / Vertex direct logic via REST if possible.
  constructor(apiKey, modelName) {
    this.apiKey = apiKey;
    this.modelName = modelName;
    this.accountId = "";
  ...
  async generateImage(prompt) {
    ...
    if (data.predictions && data.predictions[0]) {
      ...
      if (firstPred) {
        ...
        return JSON.stringify(firstPred);
      }
    }
...
__name(ImagenService, "ImagenService");
...
app.post("/generate", async (c) => {
  ...
  try {
    ...
    const imagen = new ImagenService(c.env.GOOGLE_GENAI_API_KEY, c.env.IMAGEN_MODEL_NAME);
...
// ../../node_modules/.pnpm/wrangler@3.114.15_@cloudflare+workers-types@4.20251205.0/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../../node_modules/.pnpm/wrangler@3.114.15_@cloudflare+workers-types@4.20251205.0/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-MPyx6R/middleware-insertion-facade.js
...
// ../../node_modules/.pnpm/wrangler@3.114.15_@cloudflare+workers-types@4.20251205.0/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-MPyx6R/middleware-loader.entry.ts
